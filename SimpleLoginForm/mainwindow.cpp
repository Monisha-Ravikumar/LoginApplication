    ...
    : QMainWindow(parent)
{
    QLabel *l=new QLabel(this);
       ...
       l->move(100,50);
       QPixmap p("C:/Users/MONISHA/OneDrive/Desktop/login1.png");
       l->setPixmap(p.scaled(20,20));

       QLabel *lb=new QLabel(this);
       lb->move(180,25);
       lb->setAlignment(Qt::AlignHCenter);
       QPixmap pi("C:/Users/MONISHA/OneDrive/Desktop/username.png");
       ...
       QPixmap pix("C:/Users/MONISHA/OneDrive/Desktop/password.png");
       ...
       connect(btn,&QPushButton::clicked,[=](){
           QString username=le->text();
           QString password=lie->text();
           if(username=="nithya"&& password=="dharshini")
           {
